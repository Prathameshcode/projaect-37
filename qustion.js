class Question {
    ...
    display(){
    this.title.html("Genral Science Question");
    this.title.position(350,0);

    this.question.html("What is the Name of Indian Prime Minister today ?");
    this.question.position(100,30);
    this.option1.html("1: Rajiv Gandhe");
    this.option1.position(150,60);
    this.option2.html("2: Amit Shaha");
    this.option2.position(150,100);
    this.option3.html("3: Narendra Modi");
    this.option3.position(150,140);
    this.option4.html("4: Shivsaina");
